...
String.Format("<!-- delayed-block: {0} -->", injectionBlockId) +
 ...
 String.Join(Environment.NewLine, stack));
        ...
        #region extend for partial style

        private static string InjectionBlockId_Style = "InjectionBlockId_Style";
        public static IDisposable DelayedStyle(this HtmlHelper helper, string isOnlyOne = null)
        {
            return Delayed(helper, InjectionBlockId_Style, isOnlyOne);
        }
        public static MvcHtmlString RenderDelayedStyle(this HtmlHelper helper, bool removeAfterRendering = true)
        {
            return RenderDelayed(helper, InjectionBlockId_Style, removeAfterRendering);
        }
        ...
        public static void RenderPartialIf(this HtmlHelper htmlHelper, string partialViewName, Func<bool> shouldRenderFunc)
        {
            if (!shouldRenderFunc())
                return;
